...
class EarlyStopping:
    ...
    def __init__(self, patience=30):
        ...
        self.best_iter = 0
        self.patience = patience if patience != -1 else float('inf')  # epochs to wait after fitness stops improving to stop
        self.possible_stop = False  # possible stop may occur next epoch
        self._step = -1
        self._best_step = 0

    def __call__(self, it, fitness):
        self._step += 1
        ...
        delta = self._step - self._best_step  # validation steps without improvement
        self.possible_stop = delta >= (self.patience - 1)  # possible stop may occur next validation step
